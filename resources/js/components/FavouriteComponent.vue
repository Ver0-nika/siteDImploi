<template>
    <div>
            ...
            <button v-if="show" @click.prevent="unsave()" class="btn btn-outline-dark" style="width: 100%;">UnSave</button>

            <button v-else @click.prevent="save()" class="btn btn-outline-primary" style="width: 100%;">Save</button>
